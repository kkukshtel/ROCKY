...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/images/CameraPole.png", __ASSET__assets_images_camerapole_png);
		type.set ("assets/images/CameraPole.png", AssetType.IMAGE);
		className.set ("assets/images/GokuLLeg.png", __ASSET__assets_images_gokulleg_png);
		type.set ("assets/images/GokuLLeg.png", AssetType.IMAGE);
		className.set ("assets/images/GokuULeg.png", __ASSET__assets_images_gokuuleg_png);
		...
		type.set ("assets/locales/en-US/fonts.xml", AssetType.TEXT);
		className.set ("assets/locales/en-US/ui.csv", __ASSET__assets_locales_en_us_ui_csv);
		type.set ("assets/locales/en-US/ui.csv", AssetType.TEXT);
		...
		className.set ("assets/xml/TitleMenu.xml", __ASSET__assets_xml_titlemenu_xml);
		type.set ("assets/xml/TitleMenu.xml", AssetType.TEXT);
		...
		id = "assets/images/CameraPole.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/GokuLLeg.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/GokuULeg.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		...
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/locales/en-US/fonts.xml";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "assets/locales/en-US/ui.csv";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
...
@:keep class __ASSET__assets_images_camerapole_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep class __ASSET__assets_images_gokulleg_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep class __ASSET__assets_images_gokuuleg_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep class __ASSET__assets_locales_en_us_fonts_xml extends openfl.utils.ByteArray { }
@:keep class __ASSET__assets_locales_en_us_ui_csv extends openfl.utils.ByteArray { }
@:keep class __ASSET__assets_locales_index_xml extends openfl.utils.ByteArray { }
...
@:keep class __ASSET__assets_xml_titlemenu_xml extends openfl.utils.ByteArray { }
...
@:bitmap("assets/images/CameraPole.png") class __ASSET__assets_images_camerapole_png extends flash.display.BitmapData {}
@:bitmap("assets/images/GokuLLeg.png") class __ASSET__assets_images_gokulleg_png extends flash.display.BitmapData {}
@:bitmap("assets/images/GokuULeg.png") class __ASSET__assets_images_gokuuleg_png extends flash.display.BitmapData {}
@:file("assets/images/images-go-here.txt") class __ASSET__assets_images_images_go_here_txt extends flash.utils.ByteArray {}
@:bitmap("assets/locales/_flags/cs-CZ.png") class __ASSET__assets_locales__flags_cs_cz_png extends flash.display.BitmapData {}
@:bitmap("assets/locales/_flags/de-DE.png") class __ASSET__assets_locales__flags_de_de_png extends flash.display.BitmapData {}
@:bitmap("assets/locales/_flags/en-CA.png") class __ASSET__assets_locales__flags_en_ca_png extends flash.display.BitmapData {}
@:bitmap("assets/locales/_flags/en-GB.png") class __ASSET__assets_locales__flags_en_gb_png extends flash.display.BitmapData {}
@:bitmap("assets/locales/_flags/en-US.png") class __ASSET__assets_locales__flags_en_us_png extends flash.display.BitmapData {}
@:bitmap("assets/locales/_flags/es-ES.png") class __ASSET__assets_locales__flags_es_es_png extends flash.display.BitmapData {}
@:bitmap("assets/locales/_flags/fr-FR.png") class __ASSET__assets_locales__flags_fr_fr_png extends flash.display.BitmapData {}
@:bitmap("assets/locales/_flags/it-IT.png") class __ASSET__assets_locales__flags_it_it_png extends flash.display.BitmapData {}
@:bitmap("assets/locales/_flags/ja-JP.png") class __ASSET__assets_locales__flags_ja_jp_png extends flash.display.BitmapData {}
@:bitmap("assets/locales/_flags/ko-KR.png") class __ASSET__assets_locales__flags_ko_kr_png extends flash.display.BitmapData {}
@:bitmap("assets/locales/_flags/nb-NO.png") class __ASSET__assets_locales__flags_nb_no_png extends flash.display.BitmapData {}
@:bitmap("assets/locales/_flags/pl-PL.png") class __ASSET__assets_locales__flags_pl_pl_png extends flash.display.BitmapData {}
@:bitmap("assets/locales/_flags/yo-DA.png") class __ASSET__assets_locales__flags_yo_da_png extends flash.display.BitmapData {}
@:file("assets/locales/en-US/fonts.xml") class __ASSET__assets_locales_en_us_fonts_xml extends flash.utils.ByteArray {}
@:file("assets/locales/en-US/ui.csv") class __ASSET__assets_locales_en_us_ui_csv extends flash.utils.ByteArray {}
@:file("assets/locales/index.xml") class __ASSET__assets_locales_index_xml extends flash.utils.ByteArray {}
...
@:file("assets/xml/TitleMenu.xml") class __ASSET__assets_xml_titlemenu_xml extends flash.utils.ByteArray {}
